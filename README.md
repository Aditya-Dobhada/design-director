...
| **Modern** | `dark-minimal` | **Dark Minimal** | Obsidian dark canvas, hairline borders, muted slate, Inter | `#09090B`, `#111215`, `#5E6AD2` | [dark_minimal.html](skills/design-director/gallery/dark_minimal.html) |
...
| **Historical** | `art-deco` | **Art Deco** | Obsidian & rich gold, stepped geometry, hairpin borders, 0px radius | `#0E0E10`, `#D4AF37`, `#F3E5AB` | [art_deco.html](skills/design-director/gallery/art_deco.html) |
...
| **Futuristic** | `cyberpunk` | **Cyberpunk** | Obsidian dark mode, cyan HUD, Rajdhani 700 + Mono, 8px chamfers | `#060709`, `#00F5FF`, `#FF00A0` | [cyberpunk.html](skills/design-director/gallery/cyberpunk.html) |
...
| **Experimental** | `vaporwave` | **Vaporwave** | Sunset purple-pink gradients, wireframe horizons, retro aesthetic | `#1F132B`, `#FF71CE`, `#01CDFE` | [vaporwave.html](skills/design-director/gallery/vaporwave.html) |
